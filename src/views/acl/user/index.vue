<template>
  ...
  <el-card style="margin: 10px 0px;" >
    ...
    <!--table展示用户信息-->
    <el-table @selection-change="selectChange" style="margin:20px 0px;" border :data="userArr">
...
const getHasUser=async(pager=1)=>{
  pageNO.value=pager
  let reqult:UserResponseData= await reqUserInfo(pageNO.value,pageSize.value,keyword.value)
  console.log(reqult);
  if (reqult.code==200) {
